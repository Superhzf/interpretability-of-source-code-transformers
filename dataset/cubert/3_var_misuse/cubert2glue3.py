...
def save(original_file,new_file_path_list,idx):
    path_csv, path_func, path_label = new_file_path_list
    #save as CSV
    ...
    with open(path_func, 'a') as f1, open(path_label,'a') as f2:
...
def main(original_file_folder,new_file_folder):
    ...
    for idx1,thisList in enumerate([trainList,devList,evalList]):
        ...
        path_list = [path_csv,path_func,path_label]
