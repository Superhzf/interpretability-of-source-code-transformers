...
def main():
    ...
    if dev:
        ...
        bert_probe, codebert_probe, graphcodebert_probe = visualizetion(bert_tokens, None, None,True)
    else:
        ...
        bert_probe, codebert_probe, graphcodebert_probe = visualizetion(bert_tokens, codebert_tokens, graphcodebert_tokens)
