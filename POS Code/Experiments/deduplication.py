#this is the code I use to remove redundant observations from
# codetest2.in and codetest2.label
...
f.close()
print(f"After removing redundant observations, {len(code_unique)} samples are left and written to the file")
