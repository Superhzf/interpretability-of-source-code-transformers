...
def linear_probes_inference(tokens_train, activations_train,tokens_test,activations_test,model_name):
    ...
    X_train, y_train, label2idx_train, idx2label_train = filter_by_frequency(X_train,y_train,label2idx_train,idx2label_train,3,model_name)
    X_test, y_test, label2idx_test, idx2label_test = filter_by_frequency(X_test,y_test,label2idx_test,idx2label_test,3,model_name)
