...
def linear_probes_inference(tokens, activations,model_name):
    ...
    def get_top_words(top_neurons,tokens,activations,model_name):
        ...
        idx:652, LBRACE
        [('intern', 1.0), ('{', 0.9551227767441584), ('principal', 0.9226861957688057), ('Off', 0.8991714178184206), ('factories', 0.884950459900813)]
        idx: 1448, MINUS
        ...
        idx: 7659, NOTEQUAL
        [('max_length', 1.0), ('4096', 0.9969567399372781), ('nullable', 0.9536419330846642), ('NetworkServiceAgent', 0.9208455224954317), ('decimal', 0.8778436818992581)]
        idx: 2059, AT
        ...
        idx: 124, STRING
        [('friend', 1.0), ('heads', 0.9507271889591057), ('buddy', 0.9293296194549694), ('head', 0.8610411145417163), ('neighbor', 0.8406202767100115)]
        idx: 652, LBRACE
        [('intern', 1.0), ('{', 0.9469888681803765), ('principal', 0.9182474371667484), ('Off', 0.9007017040796614), ('factories', 0.8785951069775485)]
        idx: 1448, MINUS
        [('public', 1.0), ('rest', 0.9109589355441492), ('masked', 0.9006628025649864), ('Standard', 0.8962497184995595), ('sam', 0.8935695976175985)]

        finetuned_clodedent_GraphCodeBert
        idx: 83, RSQB
    ...
    label2idx = {label:idx for (label,idx) in label2idx.items() if idx <= 40}
