...
#function to perform gridsearch on logreg model
def grid_search_logreg_model(
    ...
    params = {
        ...
        'lambda_l1': [0.0001, 0.00001, 0.000001, 0.0000001],
        'lambda_l2': [0.0001, 0.00001, 0.000001, 0.0000001],
    }
    """
    Define `GridSearchCV`.
    ...
    * 2 CVs = 672 fits.
    ...
    gs = GridSearchCV(
        net, params, refit=False, scoring='accuracy', verbose=1, cv=3
    )
