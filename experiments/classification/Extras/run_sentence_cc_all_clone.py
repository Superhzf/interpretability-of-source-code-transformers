...
CONFIGURATION_OPTIONS = {
    ...
    "train_source1": {
        "example": "training_data.word1",
        "type": "string",
        "description": "Training tokens file",
    },
    "train_source2": {
        "example": "training_data.word2",
        "type": "string",
        "description": "Training tokens file",
     },
    "train_labels": {
    ...
    "test_source1": {
        "example": "test_data.word1",
        "type": "string",
        "description": "Test tokens file",
    },
     "test_source2": {
        "example": "test_data.word2",
        "type": "string",
        "description": "Test tokens file",
    },
    "test_labels": {
...
def main():
    ...
    train_source1_path = os.path.join(config["base_dir"], config["train_source1"])
    train_source2_path = os.path.join(config["base_dir"], config["train_source2"])
    ...
    test_source1_path = os.path.join(config["base_dir"], config["test_source1"])
    test_source2_path = os.path.join(config["base_dir"], config["test_source2"])
    ...
    train_tokens = data_loader.load_sentences_data(
        train_source1_path, train_source2_path, train_labels_path, train_activations
    )
    # dev_tokens = data_loader.load_sentence_data(
    #     dev_source_path, dev_labels_path, dev_activations
    # )
    test_tokens = data_loader.load_sentences_data(
        test_source1_path, test_source2_path, test_labels_path, test_activations
    )
